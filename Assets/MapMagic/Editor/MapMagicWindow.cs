	...
	public class MapMagicWindow : EditorWindow, ISerializationCallbackReceiver
	{
		...
		private void DrawWindow()
		{
			...
			#region Toolbar
				...
				//right part
				toolbarLayout.Inset(toolbarLayout.field.width - toolbarLayout.cursor.x - 150,padding:0);
			...
			//	if (GUI.Button(script.toolbarLayout.Inset(100,padding:0), "Focus", EditorStyles.toolbarButton)) FocusOnGenerators();
				...
				if (toolbarLayout.Button("", toolbarLayout.Inset(60,padding:0), icon:"MapMagic_Zoom", style:EditorStyles.toolbarButton)) gens.layout.zoom=1;
				toolbarLayout.Label((int)(gens.layout.zoom*100)+"%", new Rect(toolbarLayout.cursor.x-42, toolbarLayout.cursor.y+3, 42, toolbarLayout.cursor.height), fontSize:8);   
		...
		public void DrawPopup ()
		{
			...
			PopupMenu.MenuItem[] popupItems = new PopupMenu.MenuItem[]
			{
				...
				new PopupMenu.MenuItem("Remove",	delegate () { if (clickedGenerator!=null) DeleteGenerator(clickedGenerator); },	disabled:clickedGenerator==null, priority:4),
				new PopupMenu.MenuItem("Reset",		delegate () { if (clickedGenerator!=null) ResetGenerator(clickedGenerator); },	disabled:clickedGenerator==null, priority:5), 
