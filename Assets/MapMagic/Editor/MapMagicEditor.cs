...
/*		#region Previewing
		...
		public override void  OnInspectorGUI ()
		{
			...
			bool modeExporting = layout.CheckButton(selectionMode == SelectionMode.exporting, "Store", rect:layout.Inset(0.3333f), icon:"MapMagic_ExportIcon");
...
//			Undo.RecordObject (script, "MapMagic settings change");
			...
			#region Mass Pin
			layout.Par(5); layout.Foldout(ref script.guiMassPin, "Mass Pin/Lock");
