...
public class FPSController : MonoBehaviour
{
	...
	public void Interactive ()
	{
		...
		if (character.inventory != null)
			character.Interactive (FPSCamera.transform.position, FPSCamera.transform.forward);
	}
	...
	public void Checking ()
	{
		...
		character.Checking (FPSCamera.transform.position, FPSCamera.transform.forward);
	}
	...
	void Update ()
	{
		...
		if (character.IsMine) {
			...
			if (pv) {
				pv.FPScamera.aimOffset = aimPosition;
			}
