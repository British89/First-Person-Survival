...
public class FPSItemThrow : FPSItemEquipment
{
	...
	public override void OnAction ()
	{
		if (Item) {
			if (throwType == 0) {
				character.CmdRequestThrowObject (this.transform.position, this.transform.rotation, ItemID, this.transform.forward * Force1);
			} else {
				character.CmdRequestThrowObject (this.transform.position, this.transform.rotation, ItemID, this.transform.forward * Force2);
			}
